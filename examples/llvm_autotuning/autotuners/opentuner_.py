...
class LlvmOptFlagsTuner(MeasurementInterface):
    ...
    def run(self, desired_result, input, limit):
        ...
        try:
            ...
            # Replace the environment benchmark with the current optimized file.
            # Use the same benchmark protocol buffer so that any dynamic
            ...
            cost = compute_observation(self.observation_space, self.tmp_optimized_path)

            return Result(time=float(cost))
